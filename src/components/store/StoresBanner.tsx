...
export const StoresBanner = () => {
  ...
  return <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-400 rounded-lg shadow-lg p-6 mb-6 text-white py-[75px]">
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <Button onClick={() => navigate("/stores")} className="bg-white text-purple-700 hover:bg-gray-100">
